...
#load(file=file.path(getwd(),"data","compound-symmetry-N-30-M-20-pordl-3-pordm-3.Rdata"))
...
persp(y=log(sort(unique(lambdas$lam_l))),
      ...
      cex.lab=0.6,
      zlab="ed")
png(file.path(getwd(),"TeX","img","compound-symmetry-true-cholesky.png"))
...
fileName <- paste0("compound-symmetry","-N-",N,"-M-",M, "-pordl-", dl, "-pordm-", dm)
